...
export default {
  data() {
    return {
      ...
      {
          id: 2,
          name: 'Full Stack Developer Internship: ReelTalk',
          imageUrl: 'reel',
          status: 'ReelTalk is a platform designed for Movie and TV show enthusiasts, offering a dynamic space for discussions and discoveries in the world of cinema and television.',
          tech: 'Node.js, React.js, Next.js, Firebase',
          github: 'null',
          demo: 'null'
        },
        {
          ...
          name: 'Resume',
          imageUrl: 'resume',
          status: ' A user-centric movie recommendation system and watchlist for streamlined film selection.',
          tech: 'NodeJS, ExpressJS, Firebase',
          github: 'null',
          demo: 'https://docs.google.com/document/d/1EtTaXOBBF-XO46IKbFebdttMIevWwpfpgTBDM2N_4t0/edit?usp=sharing'
        },
        {
          id: 4,
          name: 'Back-End Developer Internship: Oppia Foundation INC',
          imageUrl: 'oppia-logo',
          status: 'Oppia offers a unique and engaging online learning experience, specifically for the needs of under-resourced learners globally.',
        ...
        {
          id: 2,
          name: 'Nasa Hackathon-Ocean Garden',
          imageUrl: 'NasaHackPic',
          status: 'A marine biology digital awareness website, showcasing the pivotal role of phytoplankton in the ecosystems.',
          tech: 'HTML, CSS, JavaScript, Java',
          github: 'https://github.com/ihab-elrayah/Nasa-Hackathon-Ocean-Garden',
          demo: 'null'
        },
        {
          id: 3,
          name: 'Movie Swiper',
          imageUrl: 'MovieSwiper',
          status: ' A user-centric movie recommendation system and watchlist for streamlined film selection.',
          tech: 'NodeJS, ExpressJS, Firebase',
          github: 'https://github.com/ihab-elrayah/Movie-Swiper',
          demo: 'https://movie-swiper.netlify.app/'
        },
        {
          id: 4,
          name: 'USA Chicken & Biscuts',
          imageUrl: 'USA-ChickenPic',
          status: 'A local Manchester, NH restaurant, highlighting 40+ online order menu items.',
          tech: 'Java, MongoDB',
          github: 'https://github.com/ihab-elrayah/USA-CHICKEN',
          demo: 'https://usa-chicken.netlify.app/'
        },
        {
          id: 1,
          name: 'Personal Portfolio Website',
          imageUrl: 'portfolio_v2',
          status: 'My personal portfolio website, displaying my profile, skills, work expericnce, projects, and contact me page.',
          tech: 'VueJS, Tailwind',
          github: 'https://github.com/ihab-elrayah/Personal-Portfolio',
          demo: 'https://github.com/ihab-elrayah/Personal-Portfolio'
        },
        {
          id: 5,
          name: 'Calendar',
          imageUrl: 'calendar',
          status: 'Scheduling and event tracking to easily add, view, and manage their daily events.',
          tech: 'HTML, CSS, Python',
          github: 'https://github.com/ihab-elrayah/Calendar',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Calculator',
          imageUrl: 'calculator',
          status: 'Performing arithmetic operations and basic operations.',
          tech: 'HTML, CSS, JavaScript',
          github: 'https://github.com/ihab-elrayah/Calculator-/tree/main',
          demo: 'https://calculator242.netlify.app'
        }
      ]
    };
  }
      ...
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300">
            Explore my experience I've worked on so far!</h4>
        </div>
      </header>
      <section>
        <div>
